        ...
        <div className="companymission-down">
          ...
          <div className="companymission-bottom">
            ...
            <p className="companymission-text">
              ...
              all, diligent handling of budgetary means to maintain high
              standards at all levels of our activities, especially in dealings
              with employees, suppliers, subcontractors, and customers.
            </p>
          </div>
        </div>
      </div>
