...
const CoreValuesComponent=()=>{
    ...
    const happycommunity="We are building gated communities at prime locations of a metro city growing at a lightning fast pace.Every customer is a respected memeber of SRM Happy Community which is expanding day-by-day.";
    return (
        <>
