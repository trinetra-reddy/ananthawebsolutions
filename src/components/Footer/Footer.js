    ...
    <>
      <div className="footer-main-container">
        ...
        <div className="footer-container-2" >
          ...
          <div className="links">
            <div className="link_1"><Link to="/">HOME</Link></div>
            <div className="link_1"><Link to="/about-us">ABOUT US</Link></div>
            <div className="link_1"><Link to="">BLOG</Link></div>
            <div className="link_1"><Link to="/contact-us">CONTACT US</Link></div>
            <div className="link_1"><Link to="/services">SERVICES</Link></div>
          </div>
        </div>
